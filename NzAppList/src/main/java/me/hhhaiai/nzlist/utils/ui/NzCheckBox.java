...
public class NzCheckBox extends View implements Checkable {
    ...
    public NzCheckBox(Context context) {
        this(context, null);
    }

    public NzCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NzCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public NzCheckBox(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(NzCheckBox.this, mChecked);
        }
    }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(NzCheckBox checkBox, boolean isChecked);
    }
}
