...
public class Github {
    ...
    public void report(String pkgName, String appLable, String appVersion, String path, String pkgInfo) {
        try {
    ...
    private String getFileName(String pkgName, String appLable, String appVersion) {
        ...
        String result = appLable + "[" + pkgName + "]" + appVersion + "-" + Build.MANUFACTURER.toLowerCase(Locale.CHINA)
    ...
    private String getCommitMsg(String pkgInfo) {
        ...
        String deviceInfo = "[" + Build.VERSION.SDK_INT + "]" + Build.MANUFACTURER
                + "||" + Build.MODEL + "||" + Build.BRAND + "||" + Build.BOARD + "||" + pkgInfo + "||" + Build.FINGERPRINT;
